...
public class Pedal extends TextButton implements InitableInterface {
    ...
    public Pedal(String text) {
        super(text, getTextButtonStyle());
        init();
    }

     static TextButtonStyle getTextButtonStyle() {
         ...
         Texture t = Assets.manager.get(Assets.GAZ_ICON);
         ...
         Texture t2 = Assets.manager.get(Assets.GAZ_ICON);
